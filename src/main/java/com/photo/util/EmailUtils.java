...
import com.photo.task.SpringTaskController;
...
public class EmailUtils {
	...
	public static void main(String[] args) throws Exception {
		...
		prop.load(in);
		EmailUtils.sendMail(prop.getProperty("fromEmail"), prop.getProperty("toEmail"), prop.getProperty("emailName"), prop.getProperty("emailPassword"), "This is a test!", "This is a test!");
	}
	/**
	 * 发送邮件　(暂时只支持163邮箱发送)
