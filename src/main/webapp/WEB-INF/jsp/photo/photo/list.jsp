...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/photo/photo/list.js"></script>
	<div class="m-b-md">
		<form class="form-inline" role="form" id="searchForm"
			name="searchForm">
			<div class="form-group">
				<label class="control-label"> <span
					class="h4 font-thin v-middle">图片ID:</span></label> <input
					class="input-medium ui-autocomplete-input" id="photo_id"
					name="photoFormMap.photo_id">
			</div>
